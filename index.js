...
// Задача 6: Напишіть функцію, яка перевіряє, чи є число близьким до 0, але все ще більшим за Number.MIN_VALUE

function isAlmostZero(num) {
  // Перевіряємо, чи є число близьким до 0, але все ще більшим за Number.MIN_VALUE
}
